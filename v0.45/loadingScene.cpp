...
void loadingScene::loadingImage()
{
	...
	_loading->loadImage("맵2_show", "Images/맵2/map2_show.bmp", 2600, 810);
	...
	//보스맵
	_loading->loadImage("보스배경1", "Images/보스맵/boss_BackGround1.bmp", 1875, 720);
	_loading->loadImage("보스배경2", "Images/보스맵/boss_BackGround2.bmp", 1865, 720);
	_loading->loadImage("보스맵픽셀", "Images/보스맵/bossMap_Pixel.bmp", 1875, 720);
	_loading->loadFrameImage("왼쪽발판", "Images/보스맵/왼쪽발판.bmp", 7620, 180, 10, 1);
	_loading->loadFrameImage("오른쪽발판", "Images/보스맵/오른쪽발판.bmp", 7620, 180, 10, 1);
	_loading->loadImage("보스맵타일", "Images/보스맵/보스맵_타일.bmp", 1875, 720);
	//UI관련
	...
	_loading->loadFrameImage("skillCoolDown2", "Images/cooldown/skillcool_수정2.bmp", 1958, 180, 14, 1);
	...
	_loading->loadImage("병사스킬1", "Images/soldier_Skill1.bmp", 51, 51);
	_loading->loadImage("사무라이큰프로필", "Images/samurai_큰프로필.bmp", 90, 90);
	_loading->loadImage("사무라이작은프로필", "Images/samurai_작은프로필.bmp", 42, 42);
	_loading->loadImage("사무라이스킬1_icon", "Images/samurai_Skill1.bmp", 51, 51);
	_loading->loadImage("사무라이스킬2_icon", "Images/samurai_Skill2.bmp", 51, 51);
	...
	_loading->loadImage("미니맵틀", "Images/miniMap_UI.bmp", 224, 130);
	//플레이어 프레임이미지
	//일반해골
	...
	_loading->loadFrameImage("점프이펙트", "Images/jumpEfect.bmp", 720, 24, 8, 1);
	_loading->loadFrameImage("대쉬이펙트", "Images/dashEfect.bmp", 324, 62, 9, 2);
	_loading->loadFrameImage("일반해골공격이펙트", "Images/skulAttEfect.bmp", 992, 148, 8, 2);
	//머리없는 해골
	...
	_loading->loadFrameImage("사무라이스킬대시이펙트", "Images/skillDashEfect.bmp", 1098, 152, 9, 2);
	//_loading->loadFrameImage("사무라이공격이펙트", "Images/samuraiAttEfect.bmp", 792, 94, 11, 1);
	_loading->loadFrameImage("사무라이공격이펙트", "Images/samuraiAttEfect_수정.bmp", 1584, 188, 11, 1);
	//뼈무덤
	...
	//병사
	_loading->loadFrameImage("병사IDLE", "Images/enemy/Soldier_Idle.bmp", 372, 212, 6, 2);
	_loading->loadFrameImage("병사달리기", "Images/enemy/Soldier_Run.bmp", 784, 184, 8, 2);
	_loading->loadFrameImage("병사공격", "Images/enemy/Soldier_Att.bmp", 630, 240, 5, 2);
	_loading->loadFrameImage("병사히트", "Images/enemy/Soldier_Hit.bmp", 172, 188, 2, 2);
	_loading->loadFrameImage("병사죽음", "Images/enemy/Soldier_Dead.bmp", 136, 26, 1, 1);
	//큰나무
	_loading->loadFrameImage("큰나무IDLE", "Images/enemy/bigTree_IDLE.bmp", 1344, 220, 6, 1);
	_loading->loadFrameImage("큰나무공격1", "Images/enemy/bigTree_ATT.bmp", 2224, 216, 8, 1);
	_loading->loadFrameImage("큰나무공격2", "Images/enemy/bigTree_ATT2.bmp", 786, 222, 3, 1);
	_loading->loadFrameImage("큰나무총알", "Images/enemy/bigTree_Bullet.bmp", 128, 28, 4, 1);
	_loading->loadFrameImage("큰나무죽음", "Images/enemy/bigTree_DEAD.bmp", 192, 146, 1, 1);
	//큰병사
	_loading->loadFrameImage("큰병사IDLE", "Images/enemy/bigSoldier_IDLE.bmp", 1060, 384, 5, 2);
	_loading->loadFrameImage("큰병사달리기", "Images/enemy/bigSoldier_RUN.bmp", 1680, 372, 8, 2);
	_loading->loadFrameImage("큰병사공격1", "Images/enemy/bigSoldier_ATT1.bmp", 1848, 420, 7, 2);
	_loading->loadFrameImage("큰병사공격2", "Images/enemy/bigSoldier_ATT2.bmp", 444, 436, 2, 2);
	_loading->loadFrameImage("큰병사죽음", "Images/enemy/bigSoldier_DEAD.bmp", 588, 412, 2, 2);

	_loading->loadFrameImage("적소환이펙트", "Images/enemy/enemySommon_Efect.bmp", 312, 43, 6, 1);
	_loading->loadFrameImage("적죽음이펙트", "Images/enemy/enemyDead_Efect_수정.bmp", 2244, 206, 11, 1);
	...
	//보스
	//_loading->loadFrameImage("보스손IDLE", "Images/boss/IDLE.bmp", 1320, 588, 4, 2);
	_loading->loadFrameImage("보스손IDLE_R", "Images/boss/왼손_IDLE.bmp", 1320, 294, 4, 1);
	_loading->loadFrameImage("보스손IDLE_L", "Images/boss/오른손_IDLE.bmp", 1320, 294, 4, 1);
	_loading->loadImage("보스머리", "Images/boss/머리.bmp", 482, 336);
	_loading->loadImage("보스몸통", "Images/boss/몸통.bmp", 836, 682);
	_loading->loadImage("보스아랫턱", "Images/boss/아랫턱.bmp", 220, 194);
	//_loading->loadFrameImage("보스공격1", "Images/boss/Att1.bmp", 1400, 604, 4, 2);
	_loading->loadFrameImage("보스공격1_R", "Images/boss/왼손_Att1.bmp", 1400, 302, 4, 1);
	_loading->loadFrameImage("보스공격1_L", "Images/boss/오른손_Att1.bmp", 1400, 302, 4, 1);
	//_loading->loadFrameImage("보스공격2", "Images/boss/Att2.bmp", 1152, 548, 3, 2);
	_loading->loadFrameImage("보스공격2_R", "Images/boss/왼손_Att2.bmp", 1152, 274, 3, 1);
	_loading->loadFrameImage("보스공격2_L", "Images/boss/오른손_Att2.bmp", 1152, 274, 3, 1);
	_loading->loadImage("보스공격3_R", "Images/boss/왼손_Att3.bmp", 302, 334);
	_loading->loadImage("보스공격3_L", "Images/boss/오른손_Att3.bmp", 302, 334);
	_loading->loadFrameImage("보스공격2머리", "Images/boss/att2머리.bmp", 964, 336, 2, 1);
	_loading->loadFrameImage("보스공격2몸통", "Images/boss/att2몸통.bmp", 1692, 682, 2, 1);
	//_loading->loadFrameImage("보스공격2손", "Images/boss/att2손.bmp", 768, 448, 2, 2);
	_loading->loadFrameImage("보스공격2손_R", "Images/boss/왼손_Att2T.bmp", 768, 224, 2, 1);
	_loading->loadFrameImage("보스공격2손_L", "Images/boss/오른손_Att2T.bmp", 768, 224, 2, 1);
	_loading->loadFrameImage("보스공격2아랫턱", "Images/boss/att2아랫턱.bmp", 444, 194, 2, 1);
	_loading->loadFrameImage("보스죽은후머리", "Images/boss/죽은후머리.bmp", 1452, 336, 3, 1);
	_loading->loadFrameImage("보스죽은후몸통", "Images/boss/죽은후몸통.bmp", 1676, 682, 2, 1);
	_loading->loadFrameImage("보스죽은후손", "Images/boss/죽은후손.bmp", 772, 448, 2, 2);
	_loading->loadImage("보스죽은후아랫턱", "Images/boss/죽은후아랫턱.bmp", 220, 186);
	_loading->loadImage("탄막후머리", "Images/boss/탄막끝나고머리.bmp", 482, 336);
	_loading->loadFrameImage("기모으기", "Images/boss/기모으기.bmp", 11312, 354, 28, 1);
	_loading->loadFrameImage("땅이펙트", "Images/boss/땅이펙트.bmp", 10736, 414, 11, 1);
	_loading->loadImage("보스작은총알", "Images/boss/boss_Bullet.bmp", 30, 30);
	_loading->loadFrameImage("보스큰총알", "Images/boss/boss_BigBullet.bmp", 2600, 197, 13, 1);
	_loading->loadFrameImage("폭발이펙트", "Images/boss/폭발이펙트.bmp", 4080, 314, 8, 1);

	_loading->loadImage("보스체력바_Back", "Images/boss/bossHpBar_Back1.bmp", 552, 46);
	_loading->loadImage("보스체력바_Back2", "Images/boss/bossHpBar_Back2.bmp", 28, 40);
	_loading->loadImage("보스체력바_Back3", "Images/boss/bossHpBar_Back3.bmp", 28, 40);
	_loading->loadImage("보스체력바_Front", "Images/boss/bossHpBar_Front.bmp", 552, 46);
	//맵 프레임이미지
