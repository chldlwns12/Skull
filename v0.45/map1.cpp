		...
		if (DATA->getPlayer().isChange && DATA->getPlayerRuin() == SKUL)
		{
			if (DATA->getPlayer().isLeft == false)
			{
				if (DATA->getPlayerCamera().rcCamera.right >= WINSIZEX)
				{
					if (DATA->getPlayerCamera().rcCamera.right <= rcBackGround3.right)
					{
						rcBackGround1.left -= 1;
						rcBackGround1.right -= 1;
						rcBackGround2.left -= 2;
						rcBackGround2.right -= 2;
						rcBackGround3.left -= 4;
						rcBackGround3.right -= 4;
						tileX -= 4.f;
						DATA->setPixelGroundX(tileX);
						DATA->setPlayerCameraIsRight(true);
					}
		...
		if (DATA->getPlayer().isDash == true || DATA->getPlayer().isSoldierSkill || DATA->getPlayer().isSamuraiSkill1)// || DATA->getPlayer().isSamuraiSkill2)
		{
			if (DATA->getPlayer().isLeft == false)
			{
				if (DATA->getPlayerCamera().rcCamera.right >= WINSIZEX)
				{
					...
					{
						rcBackGround5.left -= 16;
						rcBackGround5.right -= 16;
						rcDoor.left -= 16;
						rcDoor.right -= 16;
						tileX -= 16.f;
						DATA->setPixelGroundX(tileX);
		...
		if (DATA->getPlayer().isChange && DATA->getPlayerRuin() == SKUL)
		{
			if (DATA->getPlayer().isLeft == false)
			{
				if (DATA->getPlayerCamera().rcCamera.right >= WINSIZEX)
				{
					if (DATA->getPlayerCamera().rcCamera.right <= rcBackGround5.right)
					{
						rcBackGround5.left -= 4;
						rcBackGround5.right -= 4;
						rcDoor.left -= 4;
						rcDoor.right -= 4;
						tileX -= 4.f;
						DATA->setPixelGroundX(tileX);
