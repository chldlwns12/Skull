...
public:
	...
	RUINSTATE* getHaveRuin() { return haveRuin; }
	...
	void setPlayerIsDash(bool dash) { sPlayer.isDash = dash; }
	void setPlayerMoveX(float X) { sPlayer.moveX = X; }
	void setIsSoldierSkill(bool is) { sPlayer.isSoldierSkill = is; }
	void setIsSamuraiSkill1(bool is) { sPlayer.isSamuraiSkill1 = is; }
	void setIsSamuraiSkill2(bool is) { sPlayer.isSamuraiSkill2 = is; }
	void setHaveRuin(RUINSTATE ruin, int i) { haveRuin[i] = ruin; }
	void setIsChange(bool is) { sPlayer.isChange = is; }
