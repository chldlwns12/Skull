...
void loadingScene::loadingImage()
{
	...
	_loading->loadImage("큰프로필", "Images/큰프로필.bmp", 90, 90);
	_loading->loadImage("작은프로필", "Images/작은프로필.bmp", 42, 42);
	_loading->loadImage("스컬스킬1", "Images/스컬스킬_1.bmp", 51, 51);
	_loading->loadImage("스컬스킬2", "Images/스컬스킬_2.bmp", 51, 51);
	_loading->loadImage("스킬칸", "Images/스킬칸.bmp", 55, 55);
