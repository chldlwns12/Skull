...
void loadingScene::loadingImage()
{
	...
	_loading->loadImage("맵1_하늘1", "Images/시작맵/시작하늘_1.bmp", 1280, 2519);
	...
	_loading->loadImage("맵1_성벽3", "Images/시작맵/성벽1.bmp", 311, 1661);
	//_loading->loadImage("맵1_성벽3", "Images/시작맵/성벽1_수정.bmp", 311, 935);
	_loading->loadImage("맵1_성", "Images/시작맵/성배경.bmp", 989, 1178);
