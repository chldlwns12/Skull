...
void inGameScene::update()
{
	...
	//}
	//
	//if (INPUT->GetKey('Z') && isRun == false && ptPlayer->getIsDash() == true)
	//{
	//	if (ptPlayer->getIsLeft() == false && ptPlayer->getIsDash() == true)
	//	{	
	//		if (ptPlayer->getRcPlayerCamera().right >= WINSIZEX)
	//		{
	//			if (ptPlayer->getRcPlayerCamera().right < rcIngameBg.right)
	...
	//		}
	//	}
	//	else if(ptPlayer->getIsLeft() == true && ptPlayer->getIsDash() == true)
	//	{
	//		if (ptPlayer->getRcPlayerCamera().left <= 0)
	//		{
	//			if (ptPlayer->getRcPlayerCamera().left > rcIngameBg.left)
...
void inGameScene::render()
{
	...
	//		sprintf(str, "%d", i);
	//		TextOut(getMemDC(), sIngameTile[i].rc.left, sIngameTile[i].rc.top, str, strlen(str));
	//	}
	//}
